...
Index Graph::num_vertices() const { return num_verts; }
...
void Graph::redistribute_edges(MPI_Comm comm)
{
    ...
    std::swap(myedges, recvbuf);
}

Edge Graph::operator[](Index i) const { return myedges[i]; }
