#!/usr/bin/env python3
"""
Parse results.m2.txt and plot phase times vs centers.
"""
...
def main():
    ...
    ap.add_argument("path", nargs="?", default="results.m2.txt", help="input results file")
    ap.add_argument("-o", "--output", default="results.m2.png", help="output image file")
    ap.add_argument("--title", default="M2 results: phase times vs centers", help="plot title")
    args = ap.parse_args()
